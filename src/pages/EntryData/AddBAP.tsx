...
import { apiCreateBAP, apiReadPenyidikan,
...
interface AddBAPProps {
    onSubmit: (params: any) => void;
    defaultValue?: any;
  }

  export const AddBAP: React.FC<AddBAPProps> = ({ 
    onSubmit, 
    defaultValue,
  }) => {
    const [formState, setFormState] = useState(
      defaultValue || { // untuk default value dari form ini
      // nama_dokumen_bap: '',
      // link_dokumen_bap: '',
      // penyidikan_id: '',
      // pdf_file_base64: '',
              ...
              <div className="grid grid-cols-2 gap-4 justify-normal">
                  ...
                  <div className="">
                    ...
                    <Select
                      ...
                      defaultValue={
                        dataPenyidikan.find(
                          (item: any) => item.penyidikan_id === formState.penyidikan_id,
                        ) || null
                      }
