...
export const AddPenyidikanModal = ({
  ...
  const handleSelectJaksa = (e: any) => {
    ...
    setFormState({ ...formState, oditur_penyidik: arrayTemp });
  ...
  const validateForm = () => {
    ...
    if (!Array.isArray(formState.oditur_penyidik) || formState.oditur_penyidik.length === 0) {
      errorFields.push('oditur_penyidik');
    }
