 ...
 return (
     <div>
       {loading ? (
          ...
          <div className="pt-3 flex flex-row m-3 pb-3">
          ...
          <div className="flex flex-col shadow-default divide-y rounded-sm border border-stroke bg-white px-2 pt-2 pb-2.5 dark:border-strokedark dark:bg-meta-4">
              ...
              <div className="text-sm flex items-center p-2.5 xl:p-3 cursor-pointer">
                  ...
                  Pidana denda sebesar : Rp. 150.000,- (seratus lima puluh ribu rupiah).
                  Membayar biaya perkara sebesar: Rp. 25.000,- (dua puluh lima ribu rupiah).
                  Barang bukti berupa : 1 (satu) buah Sim B1 No: 01/03369/3/BI atas nama Letkol Kal Suwasto Hadijoyo N.
              </div>
          </div>
          </div>
      </div>
