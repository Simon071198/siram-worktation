            ...
            {/* <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1"> */}
                <div className="flex flex-col">
                    <div className="grid grid-cols-10 rounded-t-md bg-gray-2 dark:bg-slate-600 ">
                        ...
                        <div className="p-2.5 xl:p-5 col-span-8 bg-meta-4 rounded-tr-md">
                            {/* <h5 className="text-sm font-medium uppercase xsm:text-base">
                                Tanggal Putusan
                            </h5> */}
                    ...
                    <div className="grid grid-cols-10 bg-gray-2 dark:bg-slate-600 ">
                        ...
                        <div className="p-2.5 xl:p-5 col-span-8 bg-meta-4">
                            <div className="flex flex-col">
                                    ...
                                    <div>
                                        <div className="grid grid-cols-10 rounded-sm bg-meta-4 hover:bg-sky-950">
                                            <div
                                                ...
                                                className="flex items-center justify-center gap-3 p-2.5 xl:p-5 cursor-pointer border-b border-l border-slate-600 dark:border-gray-600"
                                            >
                                            ...
                                            <div
                                                //   onClick={() => handleDetailClick(item)}
                                                className="flex items-center justify-center gap-3 p-2.5 xl:p-5 cursor-pointer col-span-3 border-b border-r border-slate-600 dark:border-gray-600"
                                            >
                                                <p className="hidden text-black dark:text-white sm:block">
                                                    {item.putusan}
                                                </p>
                    ...
                    <div className="grid grid-cols-10 bg-gray-2 dark:bg-slate-600 ">
                        ...
                        <div className="p-2.5 xl:p-5 col-span-8 bg-meta-4">
                            ...
                            <ol className='list-decimal list-inside'>
                                <li>
                                    Menyatakan Terdakwa tersebut di atas yaitu : Suwasto Hadijoyo N., Letkol Kal, NRP 522946 bersalah melakukan "Pelanggaran rambu lalu lintas";
                                </li>
                                <li>
                                    Memidana Terdakwa oleh karena itu dengan denda sejumlah Rp150.000,00 (seratus lima puluh ribu rupiah);
                                </li>
                                <li>
                                    Membebankan Terdakwa untuk membayar biaya perkara sejumlah Rp25.000,00 (dua puluh lima ribu rupiah);
                                </li>
                                <li>
                                    Menetapkan barang bukti berupa :
                                    <ul className="list-disc ml-4">
                                        <li>1 (satu) SIM B1 No: 01/03369/3/BI atas nama Letkol Kal Suwasto Hadijoyo N.</li>
                                    </ul>
                                </li>
                            </ol>
                            <br />
                    ...
                    <div className="grid grid-cols-10 bg-gray-2 dark:bg-slate-600 ">
                        ...
                        <div className="p-2.5 xl:p-5 col-span-8 bg-meta-4">
                            ...
                            <div className="flex flex-col">
                                <div className="grid grid-cols-10 text-center  rounded-t-md bg-gray-2 dark:bg-slate-600 mt-10">
