              ...
              <div className="grid grid-cols-1">
                {dummyData1.map((data, index) => {
                  return (
                    <div
                      key={index}
                      className={`dark:bg-meta-4${index !== dummyData1.length - 1 ? ' border-b bg-gray-1 ' : ''}`}
                    >
              ...
              <div className="grid grid-cols-1">
                {dummyData2.map((data, index) => {
                  return (
                    <div
                      key={index}
                      className={`dark:bg-meta-4${index !== dummyData2.length - 1 ? ' border-b bg-gray-1' : ''}`}
                    >
              ...
              <div className="grid grid-cols-1">
                {dummyData3.map((data, index) => {
                  return (
                    <div
                      key={index}
                      className={`dark:bg-meta-4${index !== dummyData3.length - 1 ? ' border-b bg-gray-1' : ''}`}
                    >
                      <div className="grid grid-cols-7 gap-9 hover:bg-sky-950">
