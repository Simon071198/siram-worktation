...
export const EditDaftarKasusModal = ({
  ...
  const [ketuaOditurPenyidikDefault, setKetuaOditurPenyidikDefault] = useState([
    {
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div className="form-group w-full ">
                    ...
                    <input
                      ...
                      defaultValue={defaultValue.nomor_kasus}
                      disabled={isDetail}
                    />
                    <div className="h-2">
                  ...
                  <div className="form-group w-full ">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      defaultValue={defaultValue?.nama_kasus}
                      disabled={isDetail}
                    />
                    <div className="h-2">
                      <p className="error-text">
                  ...
                  <div className="form-group w-full">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      defaultValue={defaultValue?.lokasi_kasus}
                      disabled={isDetail}
                    />
                    <div className="h-2">
                      <p className="error-text">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div className="form-group w-full ">
                    ...
                    <Select
                      ...
                      isDisabled={isDetail}
                      defaultValue={OditurPenyidikOpstionsDefault}
                      ...
                      >
                        ...
                        <div className="form-group w-4/6 flex items-center mr-2">
                          <input
                            ...
                            onChange={(e) => handleChangeKeterangan(e, index)} // Menggunakan parameter tambahan index
                            disabled={isDetail}
                          />
                        </div>
                      </div>
