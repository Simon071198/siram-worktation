...
import { apiUserRegister } from '../../services/api';
...
const SignUp = () => {
  ...
  const handleRegistration = async (data: any) => {
    await apiUserRegister(data).then((res) => {
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img
                  className="hidden dark:block w-30 h-30"
                  src={Logo}
                  alt="Logo"
                />
                <img className="dark:hidden" src={LogoDark} alt="Logo" />
              </Link>
              <p className="2xl:px-20 text-white font-bold text-xl">
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit(handleRegistration)}>
                ...
                <div className="mb-6">
                  ...
                  <select
                    className="w-full text-white rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                    {...register('jenis_petugas')}
                  >
                    <option value="lemasmil">Petugas Lemasmil</option>
                    <option value="otmil">Petugas Otmil</option>
                  </select>
                  <p className="px-2 text-red-800"></p>
                </div>
