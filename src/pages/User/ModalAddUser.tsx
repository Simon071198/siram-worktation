...
export const AddUserModal: React.FC<AddUserModalProps> = ({
  ...
  // const [jabatan,setJabatan]:any =useState()
  // const [matra,setMatra]:any =useState()

  const toggleShowPassword = () => {
    setShowPassword(!showPassword);
  };

  // console.log('DATAFROMPROPS',dataUser)
  ...
  const handleChange = (e: any) => {
    // if (e.target.name === 'petugas_id') {
    //   const selectedPetugas: any = staffData.find(
    //     (item: any) => item.petugas_id === e.target.value
    //   );
    //   setFormState({
    //     ...formState,
