...
//useEffect untuk menambahkan event listener  ke elemen dokumen
  ...
  const validateForm = () => {
    ...
    for (const [key, value] of Object.entries(formState)) {
      if (
        key !== 'jenis_perkara_id' // Tidak melakukan pemeriksaan pada lokasi_lemasmil_id
      ) {
        if (!value) {
  ...
  useEffect (() => {
    const fetchDataKategori = async()=> {
      try {
        const perka = await apiReadKategoriPerkara()
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-5 grid grid-cols-1 gap-4 justify-normal">
              ...
              <div className="form-group w-full flex flex-col">
                  ...
                  <select
                    className="w-full rounded border border-stroke   py-3 pl-3 pr-6.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
