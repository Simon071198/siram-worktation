...
export const DeletePengadilanMiliterModal = ({ closeModal, onSubmit, defaultValue }:any) => {
      ...
      <div className="modal rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-slate-600 overflow-auto">
        <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
          ...
          <div className="pt-6">
            ...
            Pengadilan Militer <span className='text-red-400'>{formState.nama_pengadilan_militer}</span> akan dihapus
            </p>
          </div>
