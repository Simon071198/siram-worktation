...
export const DeleteKategoriPerkaraTypeModal = ({ closeModal, onSubmit, defaultValue }:any) => {
        ...
        <div className="border-b border-stroke py-4 px-7 dark:border-strokedark">
          ...
          <div className="pt-6">
            ...
            <p className="text-sm text-center text-black dark:text-white">
              Kategori Perkara  <span className='font-semibold text-red-400'>{formState.nama_kategori_perkara}</span> akan dihapus
            </p>
          </div>
