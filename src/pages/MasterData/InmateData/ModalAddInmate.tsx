...
export const AddInmateModal = ({
  ...
  const getAllJenisPerkara = async () => {
    await apiReadAllJenisPerkara(token)
      .then((res) => {
        setJenisPerkara(res);
      })
      .catch((err) =>
  ...
  const gelangData = async () => {
    await apiGelang({
      params: {
        ...
        page: 1,
        filter: {
          // lokasi_otmil_id: "1tcb4qwu-tkxh-lgfb-9e6f-xm1k3zcu0vou"
        },
      },
    })
      .then((res) => {
