...
const OditurPenuntutList = () => {
  ...
  const handleFilterChange = async (e: any) => {
    ...
    setFilter(newFilter);
    // try {
    //   const response = await apiReadOditurPenuntut({ filter: { nama: newFilter } });
  ...
  const exportToExcel = () => {
    ...
    xlsx.writeFile(
      wb,
      `Data-OditurPenuntut ${dayjs(new Date()).format('DD-MM-YYYY HH.mm')}.xlsx`,
    );
  };
...
export default OditurPenuntutList;
