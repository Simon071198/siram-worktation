...
const shiftJaga = () => {
  ...
  //Data GrupPetugas
  const [grupPetugas, setGrupPetugas] = useState<grupPetugas[]>([]);
  ...
  const handleSubmitSchedule = async (item: any) => {
    const AddDataSchedule = await apiCreateScheduleShift(item, token);
    console.log('respon', item);
    ...
    <div className='container py-[16px]'>
      <div className="w-full rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
        ...
        <div className="flex justify-between items-center">
          <h1 className="font-bold text-xl w-2/5">Schedule Shift</h1>
        </div>
