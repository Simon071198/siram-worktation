...
export default function DatabaseSearch() {
  ...
  return (
    ...
    //       >
    //         <div>
    //           <div className="flex flex-col max-w-sm mx-auto rounded-xl overflow-hidden shadow-lg ">
    //             {renderImagePreview()}
    //             <input
    //               accept="image/*"
    //               type="file"
    ...
    //               className="block px-6 py-3 bg-primary text-white rounded-b-md text-center cursor-pointer"
    //             >
    //               Unggah Gambar
    //             </label>
    ...
    //             <button
    //           type="button"
    //           className="bg-primary mt-10 text-white px-6 py-3 rounded-md cursor-pointer"
    //           onClick={handleSearch}
    ...
    //         <div>
    //           <div className="w-[500px] mx-auto bg-meta-4  shadow-md rounded-t-md overflow-hidden">
    ...
    //         <button
    //           type="button"
    //           className="bg-primary w-[200px] text-white px-6 py-3 rounded-md cursor-pointer"
    //           onClick={handleSearch}
    //           disabled={!imagePreview}
    //         >
    //           Cari
